...
|---|---|---|---|---|---|---|---|---|
|film|индекс|idx_title|514| |1000|100.00|О(н)|
|payment|ВСЕ| | | | |16500|100.00|О(н)|
|rental|ref|rental_date, idx_fk_inventory_id, idx_fk_customer_id|rental_date|5|sakila.p.payment_date|1|100.00|O(log n)|
|customer|eq_ref|ПЕРВИЧНЫЙ|ПЕРВИЧНЫЙ|2|sakila.r.customer_id|1|100.00|O(log n)|
|inventory|eq_ref|ПЕРВИЧНЫЙ|ПЕРВИЧНЫЙ|3|sakila.r.inventory_id|1|100.00|O(log n)|
